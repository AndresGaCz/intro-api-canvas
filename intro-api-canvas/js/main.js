...
function draw_emoji() {
    const canvas = document.getElementById("canvas_emoji");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_cubic_bezier() {
    const canvas = document.getElementById("canvas_cubic_bezier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_pacman() {
    const canvas = document.getElementById("canvas_pacman");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_zelda() {
    const canvas = document.getElementById("canvas_zelda");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
